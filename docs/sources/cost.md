...
These figures are the response budgets defined in the project's benchmarks. `get_doc` returns a bounded slice of 80 lines by default, rather than a whole page.
