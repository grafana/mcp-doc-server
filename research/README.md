...
Background research and prior-art notes informing the design of `hack-doc-server` — a Go
...
- **[docs-mcp-server-use-cases.md](docs-mcp-server-use-cases.md)** — the common use cases
  ...
  retrieval, discovery, deterministic agentic retrieval) and how `hack-doc-server`'s
...
- **[docs-mcp-ecosystem.md](docs-mcp-ecosystem.md)** — prior art: a survey of the most
  ...
  borrowings, and risks for `hack-doc-server` — plus where it sits in the landscape.
...
- **[gcx-prototype-kickoff.md](gcx-prototype-kickoff.md)** — a paste-ready kickoff prompt
  for a fresh chat that mounts a `gcx docs` command on hack-doc-server's core in a gcx
